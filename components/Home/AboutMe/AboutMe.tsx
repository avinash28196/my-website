          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! My name is Avinash R, and I am a passionate software engineer and problem solver, dedicated to
                creating impactful codes that thrive on the internet. My journey in computer science began in 2013 when
                I delved into the world of building web application on the internet. Little did I know that programming skills
