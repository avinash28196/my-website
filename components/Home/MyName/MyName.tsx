...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        I&apos;m a <span className="text-AAsecondary">Data engineer</span>, I'm passionate about designing and building robust data pipelines, managing big data infrastructure, and delivering valuable insights from data to stakeholders. <br className="2xl:block hidden" />
        digital experiences. I'm always exploring new technologies and approaches to improve the <span className="text-AAsecondary">performance</span>,
        scalability, and efficiency of data systems.
        <br className="2xl:block hidden"/>
        This involves working with{" "}
        <span className="text-AAsecondary">cloud infrastructure</span>  such as {" "}
        <span className="text-AAsecondary">AWS & GCP</span>.
